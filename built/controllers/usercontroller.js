...
exports.postLogin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var request, response, errors, user, result, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                request = req.body;
                response = new LoginResponse_1.LoginResponse();
            ...
            case 1:
                ...
                return [4 /*yield*/, User.findOne({ email: request.email })];
            case 2:
                user = _a.sent();
                console.log(user);
                return [4 /*yield*/, bcrypt.compare(request.password, user.password)];
            case 3:
                result = _a.sent();
                if (!result) return [3 /*break*/, 5];
                return [4 /*yield*/, jwt.sign({ email: user.email, id: user._id }, privateKey, { expiresIn: '1h' })];
            case 4:
                token = _a.sent();
...
exports.postRegister = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var response, errors, email, password, passwordagain, user, hashedPassword, userSave;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                response = new LoginResponse_1.LoginResponse();
            ...
            case 2:
                ...
                userSave = new User({ email: email, password: hashedPassword });
                return [4 /*yield*/, userSave.save()];
            case 3:
                _a.sent();
                response.success = true;
                res.send(response);
